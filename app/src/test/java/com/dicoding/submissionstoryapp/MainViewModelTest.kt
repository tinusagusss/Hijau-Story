...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        val dummyStory = DataDummy.generateDummyNewsEntity()
//        val data: PagingData<StoryResponseItem> = PagingData.from(dummyStory)
        ...
        val actualStory: PagingData<StoryListItem> = mainViewModel.story.getOrAwaitValue()
