...
import com.dicoding.submissionstoryapp.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mainViewModel.getListLocationStory(this)
    ...
    private fun addManyMarker(storyListItems: ArrayList<StoryListItem>) {


        storyListItems.forEach { stories ->
            val latLng = LatLng(stories.latitude, stories.longitude)
            val addressName = getAddressName(stories.latitude, stories.longitude)

            mMap.addMarker(
                MarkerOptions().position(latLng).title(stories.name).snippet(addressName)
            )
