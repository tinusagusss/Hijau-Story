package com.dicoding.submissionstoryapp.customview
...
class EmailEditTxtCustomeView : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (!isValidEmail(s) && s.isNotEmpty()) error = "invalid email"
